...
drop table parent2;--calismaz
drop table parent2 cascade; -- calisir
...
UPDATE malzemeler
SET malzeme_isim = (SELECT sirket_ismi
					FROM toptancilar
...
select round(avg(fiyat),2) as ortalama_fiyati from arac;
...
--Soru-12: meslekler tablosunda ismi Ali olanların maaşıni büyükten küçüğe doğru sıralayınız maas DESC;
...
select * from meslekler where id>5 limit 4;
